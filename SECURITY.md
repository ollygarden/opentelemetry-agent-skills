...
This repository publishes agent instructions, scripts, generated references, and tooling directly
from `main`. Only the latest commit on `main` is actively maintained. Older revisions and downstream
copies may no longer reflect current security guidance.
...
This includes vulnerabilities in executable scripts, GitHub Actions workflows, dependency handling,
